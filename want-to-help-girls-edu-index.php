...
<head>
    ...
    <title>NEED HELP</title>
     ...
     <link rel="stylesheet" href="css/want-to-help-girls_edu-index-css3.css">
...
<body>
   ...
   ?>
    <div class="heading">
        <p>EDUCATE A GIRL AND SHE WILL CHANGE THE WORLD!</p>
    </div>
    <section id="header">
    ...
    <div class="wrapper">
       ...
       <div class="row">
        ...
        <div class="card">
            <img src="css/images/books_1.JPG">
            <div class="info">
                <h1> Let's Feed India </h1>
                <p> </p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-1">
        <div class="card">
            <img src="css/images/want_to_help_booksJPG.JPG">
            <div class="info">
                <h1> Let's Support India </h1>
                <p> </p>
                <a href="#" class="btn"> Click Me </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-1">
        <div class="card">
            <img src="css/images/stationary.JPG">
            <div class="info">
                <h1> Let's Feed India </h1>
                <p> </p>
                <a href="#" class="btn"> Click Me </a>
